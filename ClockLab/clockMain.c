...
int main() { //sample main just to make the thing tick
        clockDisplay_init();
...
#define TIMER_PERIOD 40.0E-3 // You can change this value to a value that you select.
