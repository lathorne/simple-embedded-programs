...
#include "../intervalTimerLab/intervalTimer.h"  // Modify as necessary to point to your intervalTimer.h
#include "supportFiles/leds.h"
#include "supportFiles/interrupts.h"
#include "../switchAndButtonLab/switches.h"  // Modify as necessary to point to your switches.h
#include "../switchAndButtonLab/buttons.h"   // Modify as necessary to point to your buttons.h
#include <stdio.h>
